            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                ...
                <input
                  ...
                  value={email}
                  onChange={(e)=>{ setEmail(e.target.value); if(errors.username) setErrors(v=>({...v, username:""})) }}
                  aria-invalid={!!errors.username}
                  aria-describedby="email-error"
                />
              </div>
            </div>
            {errors.username && <p id="email-error" className="error-message">{errors.username}</p>}
                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end", gap: "10px" }}>
                    ...
                    <button onClick={async () => {
                        ...
                        try {
                          ...
                          setResetMessage(t('auth.login.reset_success') || "Password reset link sent");
                        } catch (err) {
                    ...
                    >
                      {resetLoading ? <span style={spinnerStyle}></span> : (t('auth.login.send') || 'Send')}
                    </button>
                  </div>
