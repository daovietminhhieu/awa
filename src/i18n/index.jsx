...
export function I18nProvider({ children }) {
  ...
  for (const p of parts) {
    if (!obj) return typeof varsOrFallback === 'string' ? varsOrFallback || path : path;
    obj = obj[p];
  }
  ...
  let str = obj ?? (typeof varsOrFallback === 'string' ? varsOrFallback : null) ?? path;

  // 🔁 Nếu varsOrFallback là object thì interpolate {{var}}
  if (str && typeof str === 'string' && varsOrFallback && typeof varsOrFallback === 'object') {
